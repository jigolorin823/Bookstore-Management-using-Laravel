...
<div class="panel-group">
        <div class="panel panel-info">
          <div class="panel-heading"><h1>Best Sellers</h1></div>
          <?php
          ...
          <?php 
                ...
                // dd($orderlines);
                $orderlines2 = $orderlines->splice((($page-1)*4))->take(4);
            ?>
            
            @foreach($orderlines2 as $orderline)
            <?php 
            
                $product = $products->where('id','=',$orderline->product_id)->first();
            ?>
